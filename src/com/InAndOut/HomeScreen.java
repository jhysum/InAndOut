...
import com.InAndOut.com.Adapters.MySimpleArrayAdapter;
...
public class HomeScreen extends Activity implements LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PeopleAdapter adapter = new PeopleAdapter(this, R.layout.homescreen_item, filteruser, this.getLayoutInflater());
